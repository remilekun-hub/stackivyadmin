...
function ContactedTable<TData, TValue>({
  columns,
  data,
  ...
  return (
    <div className="overflow-hidden">
      <div className=" rounded-t-[12px] overflow-hidden mt-6">
        <Table>
        ...
        <div className="flex mt-12 items-center justify-center space-x-4 py-4">
          <Button
            size="sm"
