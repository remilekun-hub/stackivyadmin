            ...
            <div className="">
              <div className="mt-6">
                ...
                <p className="text-[#999999] leading-6">
                  Signup to Stackivy’s admin dashboard and start putting things
                  right
                </p>
              </div>
              ...
              <form className="mt-10" onSubmit={handleSubmit}>
                <label htmlFor="" className="flex flex-col gap-1 mb-4">
                  ...
                  <input
                    ...
                    name=""
                    id=""
                    className="w-full outline-0 p-4 border-[#F0F0F0] border-[2px] rounded-[4px]"
                ...
                <p className="text-[13px] leading-[22px] font-normal text-center">
