        ...
        <header className='h-[100px] flex items-center'>
          ...
          <div className=''>
              <div className='mt-6'>
                ...
                <p className='text-[#999999] leading-6'>Signup to Stackivy’s admin dashboard and start putting things right</p>
              </div>
              ...
              <form className='mt-10' onSubmit={handleSubmit}>
                ...
                <input type="text" name="" id="" className='w-full outline-0 p-4 border-[#F0F0F0] border-[2px] rounded-[4px]' placeholder='Enter Name'/>                    
                </label>
                ...
                <p className='text-[13px] leading-[22px] font-normal text-center'>Already have an account? <span className='text-[#116B89]'><Link to={'/sign-in'}>Sign in</Link></span></p>
              </form>
          </div>
        </div>
