        ...
        <header className='h-[100px] flex items-center'>
          ...
          <div className=''>
              ...
              <label htmlFor="" className='flex flex-col gap-1 mb-4'>
                ...
                <button className='mb-4 bg-[#116B89] p-5 w-full text-white rounded-full text-[14px] leading-[22px] font-medium mt-7 hover:bg-[#0E5971] focus:bg-[#0E5971] transition'>Reset Password</button>
